...
// add a new product if one is chosen
	if(isset($_REQUEST['addtocart']))
	{
			...
			mysql_query("insert into cart values (NULL, '$cartid', '$productid', '$quantity', '$unitsubtotal')") or die(mysql_error());
	} 
...
<div class="cartfooter">
	...
	<div class="continueshopping">
		...
		<a href='productshop.php?cartid=<?php echo "$cartid"; ?>'>Continue Shopping</a>
